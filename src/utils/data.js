...
export const mealPlanningSamples = [
    {
        col1: 'Breakfast',
        col2: ['All-bran cereal (125)', 'Milk (50)', 'Banana (90)'],
        col3: ['Granola (120)', 'Greek yogurt (120)', 'Blueberries (40)'],
        col4: ['Buttered toast (150)', 'Egg (80)', 'Banana (90)', 'Almonds (170)']
    },
    {
        col1: 'Snack',
        col2: ['Cucumber (30)', 'Avocado dip (50)'],
        col3: ['Orange (70)'],
        col4: ['Greek yogurt (120)', 'Blueberries (40)']
    },
    {
        col1: 'Total',
        col2:'345 Calories',
    ...
    {
        col1: 'Lunch',
        col2: ['Grilled cheese with tomato (300)', 'Salad (50)'],
        col3: ['Chicken and vegetable soup (300)', 'Bread (100)'],
        col4: ['Grilled chicken (225)', 'Grilled vegetables (125)', 'Pasta (185)']
    },
    {
        col1: 'Snack',
        col2: ['Walnuts (100)'],
        col3: ['Apple (75)', 'Peanut butter (75)'],
        col4: ['Hummus (50)', 'Baby carrots (35)', 'Crackers (65)']
    },
    {
        col1: 'Total',
        col2: '450 Calories',
    ...
    {
        col1: 'Dinner',
        col2: ['Grilled Chicken (200)', 'Brussel sprouts (100)',' Quinoa (105)'],
        col3: ['Steak (375)', 'Mashed potatoes (150)', 'Asparagus (75)'],
        col4: ['Grilled salmon (225)', 'Brown rice (175)', 'Green beans (100)', 'Walnuts (165)']
    },
    {
        col1: 'Total',
        col2: '405 Calories',
